    ...
    return (
        <section>
            <div className="container mx-auto xl:px-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 mb-20 h-full gap-4 md:gap-3 lg:gap-2">
                    ...
                    <div>
                        ...
                        <a href={`/`} target="_blank" className='py-2 px-2 lg:py-2 lg:px-4 text-sm lg:text-md bg-button rounded' rel="noreferrer">Watch Trailer</a>
                        </div>
                    </div>
                </div>
            </div>
